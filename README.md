...
2. Data is separated into two categories:
   - Sunny
   - Rainy
3. Average values for each category are calculated.
4. The system compares user input with averages using distance formula.
5. The closest match determines the predicted weather.
...
- Good for learning basic prediction logic
